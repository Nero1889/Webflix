...
function Results() {
    ...
    return (
        <div className="bg-slate-950 min-h-screen text-white">
            ...
            z-30 sm:mx-[1.5rem] xl:mx-[3.5rem] 2xl:mx-[5.5rem]">
                ...
                {/* Results Search Bar */}
                <div className="relative lg:w-[24rem] h-[2.5rem] xl:w-[34rem]">
                    ...
                    {searchInput.length > 0 && suggestions.length > 0 && !loadingSuggestions && isInputFocused && (
                        ...
                        style={{borderRadius: "0 0 1rem 1rem"}}>
                            {suggestions.map((item) => (
                                ...
                                hover:bg-slate-800 cursor-pointer transition-colors duration-200"
                                onMouseDown={() => {
                                    setSuggestions([]);
                                    navigate(`/results?query=${encodeURIComponent(item.title || item.name)}`);
                                }}>
                                    {item.media_type === "person" ? (
                                        item.profile_path ? (
                                            ...
                                            <img src={actor} alt="Actor" className="w-[2rem]
                                            h-[2rem] rounded-full" draggable="false"/>
                                        )
                                    ) : (
            ...
            {error && (
                <p className="text-[#b71234] text-center mt-[5rem] p-4 border-rose-600
